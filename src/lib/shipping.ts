// Two-letter ISO country codes that Stripe Checkout accepts in
// shipping_address_collection.allowed_countries. This is the full
// shippable list minus the sanctioned set Stripe rejects (CU, IR, KP,
// SY) and a handful of disputed/unsupported codes.
//
// Source: https://docs.stripe.com/api/checkout/sessions/create#create_checkout_session-shipping_address_collection-allowed_countries
export const SHIPPING_COUNTRIES: ReadonlyArray<string> = [
